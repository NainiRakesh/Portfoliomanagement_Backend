...
public class DataEntry {
	...
	@Column(name="Oniste_Project_Manager")
	...
	public DataEntry(Integer id, Date month, String vertical, String classification, String deliveryManager,
			...
			float value, String type, int financialYear, String quarter, int probability, int projectsOrPursuitStage,
	...
	public int getProjectsOrPursuitStage() {
		return projectsOrPursuitStage;
	}
	public void setProjectsOrPursuitStage(int projectsOrPursuitStage) {
		this.projectsOrPursuitStage = projectsOrPursuitStage;
	}
    ...
    @OneToOne(mappedBy = "dataEntry", cascade = CascadeType.ALL)
    private AcBudgets acBudgets;
